...
public class FaceSpot {
	...
	private static final String AppID = "23833655";
	private static final String APIKey = "1iS86wTxiperqCX4eBooqgId";
	private static final String SecretKey = "TloYYqXk4OBGfpwmBvXS3GOxZGLMQ7v2";
	 ...
	 * @return
	 */
	public static JSONObject searchFace(File file, String groupIdList, String userId) {
		try {
	 ...
	 * @return
	 */
	public static JSONObject searchFace(byte[] arg0, String groupIdList,
			String userId) {
		String imgStr = Base64Util.encode(arg0);
		String imageType = "BASE64";
		HashMap<String, String> options = new HashMap<String, String>();
